...
export const Rating = React.forwardRef<HTMLDivElement, RatingProps>(({ value, onChange, max = 5, icon = 'star', size = 'md', readOnly = false, className, ...props }, ref) => {
    ...
    return (
        <div ref={ref} className={cn('flex items-center h-10', className)} {...props}>
